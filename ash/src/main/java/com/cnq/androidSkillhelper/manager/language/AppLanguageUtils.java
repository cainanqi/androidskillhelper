package com.cnq.androidSkillhelper.manager.language;
...
public class AppLanguageUtils {
    ...
    private static HashMap<String, Locale> mAllLanguages = new HashMap<String, Locale>(7) {{
        ...
        put(ConstantLanguages.SPINISH, new Locale(ConstantLanguages.SPINISH, "ES"));
    ...
    public static void changeAppLanguage(Context context, String newLanguage) {
        ...
        Log.e("locale:", "changeAppLanguage:" + locale.getLanguage());
    ...
    private static Context updateResources(Context context, String language) {
        ...
        Log.e("locale:", "updateResources:" + curLocale.getLanguage());
    ...
    public static void setLanguageInit(Context context) {
        Locale curLocale = context.getResources().getConfiguration().locale;
        LocalConstant.currentLanguage=curLocale.getLanguage();
    }

    public static boolean languageIsEqual() {

        return LocalConstant.currentLanguage.equals(LocalConstant.savedLanguage);
    }
}
